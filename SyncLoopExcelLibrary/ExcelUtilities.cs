...
namespace SyncLoopExcelLibrary
{
    public static class ExcelUtilities
    {
        ...
        public static string CreateExcelDocument(List<Character> listOfCharacters, ProgramInfo data, List<Loop> listOfLoops)
        {
            ...
            // TODO: Modify constructor to accept parameters from settings.
            ...
            stylesList.Add(new Style()
            {
                ...
                Font = new StyleFont("Calibri", "14", "#000000")
            });
            // Borders, wrap, bold.
            stylesList.Add(new Style()
            {
            ...
            // Program.
            infoHeaderCells.Add(new Cell("GreyBackgroundWithBorders", Cell.DataType.String, "NOMBRE DEL PROGRAMA"));
            // ID.
                    ...
                    new Row(
                        new List<Cell>()
                        {
                            ...
                            new Cell(
                                "Borders",
                                Cell.DataType.String,
                                data.EpisodeChannel.Code + NewLine +
                                data.EpisodeCode,
                                new CellMerge(0, cellsToMergeDown),
                                ""),
                            new Cell(
            ...
            // Loop.
            programSheetColumns.Add(new Column("30", "TextWrapNoBorders", Column.AutoFit.False, Column.ColumnHidden.True));
            // Timecode.
                        ...
                        programSheetRows.Add(
                               new Row(
                                   new List<Cell>()
                                   {
                                    ...
                                    new Cell("Borders", Cell.DataType.String, loop.CharacterName),
                                    new Cell("CourierNewWithBordersLeftAligned", Cell.DataType.String, loop.CharacterDialog,"5"),
                                    new Cell("Calibri14", Cell.DataType.Number, loop.LoopLines.ToString()),
                           }));
                        loopCounter++;
                    }
                }
